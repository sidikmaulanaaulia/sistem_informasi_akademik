...
if (isset($_POST['update'])) {
  ...
  $update_data = mysqli_query($conn,"UPDATE nama_kategori='$kategori'  WHERE id_kategori='$id'");
...
$id = $_GET['id'];
$kategori_buku = mysqli_query($conn,"SELECT * FROM kategori_buku WHERE id_kategori='$id'");
