  ...
  <div class="card mt-3">
    ...
    <div class="nav nav-tabs " id="nav-tab" role="tablist">
      ...
      <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Tahun III</button>
        <a class="btn btn-primary" href="detail-siswa-perpus.php?id=<?php echo $id_siswa?>">Data Perpus</a>
        <a class="btn btn-danger" href="siswa-bk.php?id=<?php echo $id_siswa ?>">Data BK</a>
    </div>
    <!-- Tab panes -->
    <div class="tab-content" id="nav-tabContent">
      ...
      <?php while($row = mysqli_fetch_array($data_bulan)) : ?>
        <tr>
          ...
          <!-- jumlah pembayaran -->
          <?php
          $data_jumlah = mysqli_query($conn,"SELECT nama_kasir,jumlah FROM pembayaran WHERE nis='$nis_siswa' AND bulan='$bulan'");
