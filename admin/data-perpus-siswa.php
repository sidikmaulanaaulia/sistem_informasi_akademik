...
<div class="page-wrapper mt-3 bg-white">
  ...
  <!-- Tabs -->
  <div class="card mt-3">
  <h3 class="text-center">Data Peminjaman <?php echo $nama_siswa; ?></h3>
    <!-- Nav tabs -->
          ...
          <tbody>
           ...
           while ($d = mysqli_fetch_array($data)) {
            ...
            <tr>
              ...
              <!-- status -->
              <td>
                <?php if (mysqli_num_rows($data_buku) >= 1) {
                  echo '<i class="fa fa-check" aria-hidden="true"><font color="blue">Sukses</font></i>';
                }else{
                  echo '<em><font color="red">Belum Ada</font></em>';
                }
                 ?>
              </td>
            </tr>
