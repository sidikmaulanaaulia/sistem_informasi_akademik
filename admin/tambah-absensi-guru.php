	...
	date_default_timezone_set('Asia/Jakarta');
      ...
      $status_kehadiran = $_POST['status_kehadiran'];
		  ...
		  if (mysqli_num_rows($cek_absensi) == 1) {
			  ...
			  $data_absensi = mysqli_query($conn,"INSERT INTO tabel_absensi_guru (nig_guru,tanggal_absensi,status_kehadiran,waktu_absensi) VALUES ('$nig_guru','$tanggal_sekarang','$status_kehadiran','$waktu_absensi')");
...
<div class="page-wrapper bg-white">
  ...
  <!-- ============================================================== -->
  <!-- start welcome -->  
  <h3 class="text-center">From Absensi Masuk Guru</h3>
