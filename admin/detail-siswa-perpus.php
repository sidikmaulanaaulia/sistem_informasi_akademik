...
<div class="page-wrapper bg-white">
  ...
  <!-- Tabs -->
  <div class="card mt-3">
  <h3 class="text-center">Data Perpustakaan <?php  echo $nama_siswa; ?></h3>
    <!-- Nav tabs -->
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <a class="btn btn-primary" href="data-perpus-siswa.php?id=<?php echo  base64_encode($id_siswa); ?>">Peminjaman</a>
    </div>
    <!-- Tab panes -->
