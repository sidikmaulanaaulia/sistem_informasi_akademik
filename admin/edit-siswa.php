...
if (isset($_POST['simpan'])) {
	...
	$data_siswa = mysqli_query($conn,"UPDATE tabel_siswa SET nis_siswa='$nis_siswa',nama_siswa='$nama_siswa',id_kelas='$kelas',alamat='$alamat',tgl_lahir='$tanggal_lahir',tempat_lahir='$tempat_lahir',agama='$agama',jarak_tempuh='$jarak_tempuh',nama_ortu='$nama_orang_tua',tahun_masuk='$tahun_masuk' WHERE id='$id'");
...
<div class="page-wrapper">
	...
	<form action="" method="post">
		<div class="container bg-white mt-2 p-3">
			<h3 class="text-center">From Edit Data Siswa</h3>
